          ...
          >
            ...
            {f.hasFollowed ? (
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-[#78B3CE] rounded-md hover:bg-[#5c9bb8] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#78B3CE]"
              >
                팔로우
              </button>
            )}
