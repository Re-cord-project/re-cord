...
import NewPostList from '@/components/home/newPostList'
            ...
            <section className="container mx-auto px-4 py-8">
                ...
                <div className="mb-6 border-b border-gray-200">
                    <div className="flex overflow-x-auto">
                        <button className="px-4 py-2 text-sm font-medium text-[#78B3CE] border-b-2 border-[#78B3CE]">
                            코드랩
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {bootcampPosts.map((post) => (
                        <div
                            ...
                            className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow"
                        >
                            <div className="h-40 bg-gray-200">{/* Replace with actual images */}</div>
                            <div className="p-4">
                ...
                <div className="text-center mt-8">
                    <button className="px-6 py-2 border border-gray-300 rounded-md text-sm text-gray-600 hover:bg-gray-50">
                        더보기
                    </button>
                </div>
            </section>
