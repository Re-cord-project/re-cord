            ...
            <div className="w-full max-w-[500px] p-8 bg-white rounded-lg shadow-sm relative">
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-6 space-y-3">
                        <a
                            href={`${socialLoginForKakaoUrl}?redirect_uri=${redirectUrlAfterSocialLogin}`}
                        ...
                        >
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#391B1B">
                                <path fillRule="evenodd" d="M11.976 2.25c-6.075 0-11 3.826-11 8.544 0 2.981 1.982 5.592 4.956 7.072l-1.003 3.595a.75.75 0 001.075.831l4.29-2.85c.546.054 1.106.09 1.682.09 6.075 0 11-3.826 11-8.544s-4.925-8.544-11-8.544z"/>
                            </svg>
                            카카오톡으로 로그인
                        </a>
                        <a
                            href={`${socialLoginForGithubUrl}?redirect_uri=${redirectUrlAfterSocialLogin}`}
