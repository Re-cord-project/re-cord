...
public class ApiV1FollowController {
    ...
    public ResponseEntity<String> followUser(
        ...
        // Service가 userId로 직접 조회하므로 controller에선 ID만 넘기면 됩니다.
    ...
    public ResponseEntity<List<FollowUserResponse>> getFollowingList(
        ...
        List<FollowUserResponse> followings = followService.getFollowingList(currentUser.getId());
    ...
    public ResponseEntity<List<FollowUserResponse>> getFollowerList(
        ...
        List<FollowUserResponse> followers = followService.getFollowerList(currentUser.getId());
